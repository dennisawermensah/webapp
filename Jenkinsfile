  ...
  stages {
   ...
   stage ('Check-Git-Secrets') {
      steps {
        ...
        sh 'sudo docker run gesellix/trufflehog --json https://github.com/dennisawermensah/webapp.git > trufflehog'
    ...
    stage ('Source Composition Analysis') {
      steps {
         sh 'rm owasp* || true'
         sh 'wget "https://raw.githubusercontent.com/dennisawermensah/webapp/master/owasp-dependency-check.sh" '
